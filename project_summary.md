...
| **Phiên bản hiện tại** | **v4.3.193** |
| **v4.3.193** | ✅ **Khắc Phục Khoảng Trống Navbar Desktop & Chuyển Titlebar Sang Sticky Flow (v4.3.193)**: Loại bỏ thuộc tính `padding-top: 32px` bị trùng lặp trên `body` và chuyển `#tauriTitlebar` sang cơ chế `position: sticky; top: 0`. Navbar của WeLove, Hồ Sơ Y Tế, Thu Chi, Quỹ... hiển thị liền mạch ngay dưới thanh tiêu đề với khoảng cách 0px hoàn hảo, không còn khoảng trống thừa trên bản Windows. |
