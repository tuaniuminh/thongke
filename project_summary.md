...
| **v4.3.133** | ✅ **Sửa Triệt Để Lỗi Hiển Thị Dư Tab Và Đổi Tên Logo Thành FamiLife Khi Tải Lại Trang (F5) (v4.3.133)**: Ẩn mặc định Tab phụ trên HTML, đồng bộ Navbar khi tải trang theo Hash, đảm bảo tên logo hiển thị đúng 100% khi nhấn F5. Nâng phiên bản toàn hệ thống sang `?v=4.3.133`. |
