...
| **Phiên bản hiện tại** | **v4.0.80** |
| **v4.0.80** | ✅ **Sửa lỗi đồng bộ khóa E2EE đa thiết bị:** Đã giải quyết triệt để lỗi mất dữ liệu hoặc số dư quỹ gia đình về 0 khi đăng nhập trên thiết bị mới (điện thoại hoặc tab ẩn danh). Bằng cách nhúng và lưu trữ các trường khóa mật mã (`fundSymmetricKey`, `asymmetricPublicKey`, `asymmetricPrivateKeyEncrypted`) trực tiếp vào trong gói tin cá nhân `personalPayload` (được mã hóa bảo mật tuyệt đối bằng Master Password trước khi upload), thiết bị mới sau khi mở khóa có thể tự động khôi phục toàn bộ cặp khóa công khai/riêng tư và mã khóa Quỹ để giải mã dữ liệu quỹ chung chính xác, tránh việc tự sinh lại cặp khóa mới làm lệch khóa giải mã. |
| **v4.0.79** | ✅ **Nâng cấp Cấu hình Quỹ & Lời mời Spouse:** Chuyển tùy chỉnh đóng góp quỹ vào modal Chỉnh sửa Quỹ. Thêm nút Đóng góp mặc định cho Quỹ đầu tư, loại bỏ khỏi Quỹ chi tiêu. Ẩn các tab "Hồ sơ y tế", "Tổng quan", "Quản lý" trên sidebar khi mở Cài đặt. Thêm tùy chọn ẩn/hiện card "Quỹ gia đình" trên trang chủ (mặc định ẩn). Hỗ trợ hiển thị Banner lời mời tham gia Quỹ gia đình từ đối tác liên kết liên tục đến khi chọn Đồng ý (sẽ tự động bật hiện card Quỹ gia đình) hoặc Từ chối. |
| **v4.0.78** | ✅ **Nâng cấp Đóng góp Quỹ & Đồng bộ Đối ngoại:** Cải tiến nhập tiền viết tắt (nhân 1000 cho mọi số dưới 1 triệu). Cho phép đóng góp từ tiền riêng vào Quỹ chi tiêu & Quỹ tùy chỉnh. Thêm tùy chọn "Cho phép đóng góp" khi tạo quỹ mới. Bỏ phần chú thích trong ngoặc đơn ở 3 quỹ gốc. Thêm loại sự kiện & tính năng đồng bộ sang "Tiền tôi mừng" trong Thu chi đối ngoại, hỗ trợ người được chia sẻ đóng góp/chi tiêu và tự động cập nhật hai đầu thời gian thực. |
