...
| **Phiên bản hiện tại** | **v4.3.279** |
| **v4.3.279** | ⚡ **Khắc Phục Lỗi Cú Pháp SyntaxError Do Khai Báo Xuất Trùng Lặp Trong app.js (v4.3.279)**: Loại bỏ khai báo trùng lặp `showAiProgress` và `hideAiProgress` trong câu lệnh `export` tại dòng 5602 của app.js, khắc phục triệt để lỗi parse ES module `Duplicate export of 'showAiProgress'` (ERR-101) trên WKWebView/iOS, ứng dụng nạp lại trơn tru. |
