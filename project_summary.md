...
| **Phiên bản hiện tại** | **v4.3.150** |
| **v4.3.150** | ✅ **Cải Tiến Chiều Cao Bằng Nhau, Tràn Viền Album Ảnh & Sửa Phông Chữ Unicode Tiếng Việt (v4.3.150)**: Sắp đặt hai cột trên có chiều cao kéo giãn bằng nhau (`align-items: stretch`) trên Desktop; di chuyển Album ảnh kỷ niệm xuống hàng dưới mở rộng 100% chiều rộng màn hình. Khắc phục lỗi hiển thị dấu tiếng Việt của phông chữ trích dẫn bằng phông chữ Georgia nghiêng cổ điển sang trọng. Thay thế vòng tròn đếm ốm màu cam đậm chói chang bằng thiết kế kính mờ thạch anh (Frosted Quartz) mượt mà tinh tế. Nâng phiên bản toàn hệ thống sang `?v=4.3.150`. |
| **v4.3.149** | ✅ **Thiết Kế Lại Giao Diện Desktop We Love Theo Bảng Màu Champagne Gold & Obsidian (v4.3.149)**: Cải tổ giao diện máy tính với tỷ lệ cột 4:6 (`grid-template-columns: 0.9fr 1.1fr`), thay đổi toàn bộ tông màu hồng chói mắt sang màu vàng Champagne hoàng gia & trắng ngọc trai (Light Mode) và đen Obsidian & tím Amethyst thạch anh (Dark Mode). Bọc phông chữ viết tay Handwriting mềm mại cho phần trích dẫn tiếng Việt trên Desktop. Nâng phiên bản toàn hệ thống sang `?v=4.3.149`. |
