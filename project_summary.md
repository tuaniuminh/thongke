...
| **v4.3.131** | ✅ **Khôi Phục Màu Chữ Đen/Tối Mặc Định Cho Tiêu Đề Dòng Bên Dưới Navbar (#currentTabTitle) (v4.3.131)**: Loại bỏ hoàn toàn hiệu ứng phủ màu gradient trên tiêu đề trang bên dưới Navbar (`#currentTabTitle`, ví dụ: *"Tổng quan"*, *"Tiền tôi nhận"*, *"Hồ sơ y tế"*, *"Tổng quan Quỹ"*) và gán về màu đen tối tiêu chuẩn `#111827` (trong Light Mode). Chỉ giữ phủ màu gradient sắc nét duy nhất cho tiêu đề tên Card trên Navbar (`.logo-text` & `.mobile-navbar-title`). Nâng phiên bản toàn hệ thống sang `?v=4.3.131`. |
