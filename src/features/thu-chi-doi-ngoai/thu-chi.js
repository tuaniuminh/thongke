...
import * as sync from '../../core/sync.js?v=4.6.2';
import { encrypt, decrypt } from '../../core/crypto.js?v=4.6.2';
import { updateLoveWidgetUI } from '../we-love/we-love.js?v=4.6.2';
...
function updateHomeLayoutUI() {
    ...
    // --- Lời mời tham gia Quỹ gia đình --- (Đã tắt ở v4.6.2 vì đã có Mã ghép đôi WeLove ghép nối trực tiếp)
