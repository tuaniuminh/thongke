...
} from '../../core/app.js?v=4.2.34';
import * as sync from '../../core/sync.js?v=4.2.34';
import { updateSidebarNavVisibility } from '../thu-chi-doi-ngoai/thu-chi.js?v=4.2.34';
...
function getAudioInstance() {
    if (!weLoveAudio) {
        weLoveAudio = new Audio('./mot-doi.mp3?v=4.2.34');
...
function initMediaSession() {
    ...
    if ('mediaSession' in navigator && aud) {
        const logoPath = './logo_pwa_small.png?v=4.2.34';
