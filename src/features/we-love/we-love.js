...
} from '../../core/app.js?v=4.3.69';
import * as sync from '../../core/sync.js?v=4.3.69';
import { encrypt, decrypt } from '../../core/crypto.js?v=4.3.69';
...
function getAudioInstance() {
    if (!weLoveAudio) {
        weLoveAudio = new Audio('./mot-doi.mp3?v=4.3.69');
...
function initMediaSession() {
    ...
    if ('mediaSession' in navigator && aud) {
        const logoPath = './logo_pwa_small.png?v=4.3.69';
