...
} from '../features/thu-chi-doi-ngoai/thu-chi.js?v=4.1.54';
import { initHealthBindings, renderHealthDashboard, updateProfileDropdowns } from '../features/ho-so-y-te/ho-so-y-te.js?v=4.1.54';
import { initFundBindings, renderFundDashboard, renderManagementTab } from '../features/quy-gia-dinh/quy-gia-dinh.js?v=4.1.54';
import { checkNewMonthNotification } from '../features/quy-gia-dinh/bao-cao-thang.js?v=4.1.54';
// app.js - Main Application Logic & UI Control
import { encrypt, decrypt, generateAsymmetricKeypair, encryptWithPublicKey, decryptWithPrivateKey } from './crypto.js?v=4.1.54';
import * as sync from './sync.js?v=4.1.54';
import { updateHomeWeather } from '../features/thoi-tiet/thoi-tiet.js?v=4.1.54';

const APP_VERSION = '4.1.54';
...
async function initializeApp() {
    ...
    // Swipe gesture for interactive back navigation on iOS/Android (Fixed for iOS Webview)
    let touchStartX = 0;
    let touchStartY = 0;
    let isSwiping = false;
    ...
    document.addEventListener('touchmove', (e) => {
        ...
        if (isSwiping) {
            // Khóa cuộn native dọc của WebView để tránh bị iOS chặn sự kiện touchmove
            if (e.cancelable) {
                e.preventDefault();
            }
