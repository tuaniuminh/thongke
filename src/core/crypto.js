...
// Helper to derive key with specific legacy parameters or new parameters
async function deriveKeyWithParams(password, salt, hash = 'SHA-512', iterations = 600000) {
...
export async function decrypt(cipherText, password) {
    ...
    const candidates = [
        ...
        { hash: 'SHA-256', iterations: 100000 },  // Lừa lõi: dữ liệu lỡ mã hóa bằng v4.5.3
...
// v4.5.3: Nâng lên 4096-bit + SHA-512 cho keypair mới.
